...
GxEPD2_750c_Z08(/*CS=5*/ CS_Pin, /*DC=*/ DC_Pin, /*RST=*/ RES_Pin, /*BUSY=*/ BUSY_Pin));

//GxEPD2_3C<GxEPD2_420c_GDEY042Z98, GxEPD2_420c_GDEY042Z98::HEIGHT> display(
//GxEPD2_420c_GDEY042Z98(/*CS=5*/ CS_Pin, /*DC=*/ DC_Pin, /*RST=*/ RES_Pin, /*BUSY=*/ BUSY_Pin)); // GDEY042Z98 400x300, SSD1683 (no inking)
...
void setup() {
  SPI.begin (SCK_Pin,99,SDI_Pin,CS_Pin);
