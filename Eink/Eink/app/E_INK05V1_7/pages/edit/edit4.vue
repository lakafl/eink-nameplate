	...
	<view class="page-container">
		...
		<view class="edit-area">
			...
			<view class="template-container">
				<image class="template-image" src="/static/moban4.jpg" mode="aspectFit"></image>
				...
				>
					{{ currentPosition && currentPosition.trim() ? currentPosition : '职位' }}
				</view>
				...
				try {
					...
					try {
						...
						if (this.currentUnit.trim()) {
							...
							ctx.fillText(this.currentUnit, 20, 30); // 顶部10%位置，靠左
						}
						...
						if (this.currentPosition.trim()) {
							...
							ctx.fillText(this.currentPosition, 380, 275); // 底部20%位置，靠右
						}
